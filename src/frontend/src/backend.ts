...
export class Backend implements backendInterface {
    ...
    async makePayment(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async rechargeMobile(arg0: bigint, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.rechargeMobile(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setPin(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
